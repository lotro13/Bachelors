...
import org.springframework.boot.autoconfigure.flyway._FactoryProvider;
...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(DatabaseInitializerDetector.class, () -> _FactoryProvider.flywayMigrationInitializerDatabaseInitializerDetector());
    ...
    factories.add(FailureAnalyzer.class, () -> _FactoryProvider.flywayMigrationScriptMissingFailureAnalyzer());
